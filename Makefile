...
src/graph/graph.o: src/graph/graph.cpp include/graph.h
	g++ -Iinclude $(opts) $(def) -c src/graph/graph.cpp -o src/graph/graph.o

src/graph/iostream.o: src/graph/iostream.cpp include/graph.h
	g++ -Iinclude $(opts) $(def) -c src/graph/iostream.cpp -o src/graph/iostream.o

src/graph/advancedTraverse.o: src/graph/advancedTraverse.cpp include/graph.h
	g++ -Iinclude $(opts) $(def) -c src/graph/advancedTraverse.cpp -o src/graph/advancedTraverse.o

src/graph/solveILP.o: src/graph/solveILP.cpp include/graph.h
	g++ -Iinclude -Ilp_solve -Ilp_solve/bfp -Ilp_solve/bfp/bfp_LUSOL -Ilp_solve/bfp/bfp_LUSOL/LUSOL -Ilp_solve/colamd -Ilp_solve/shared $(opts) $(def) -DYY_NEVER_INTERACTIVE -DPARSER_LP -DINVERSE_ACTIVE=INVERSE_LUSOL -DRoleIsExternalInvEngine -c src/graph/solveILP.cpp -o $@

src/ILP/demo.o: src/ILP/demo.cpp include/ILP.h
	g++ -Iinclude -Ilp_solve -Ilp_solve/bfp -Ilp_solve/bfp/bfp_LUSOL -Ilp_solve/bfp/bfp_LUSOL/LUSOL -Ilp_solve/colamd -Ilp_solve/shared $(opts) $(def) -DYY_NEVER_INTERACTIVE -DPARSER_LP -DINVERSE_ACTIVE=INVERSE_LUSOL -DRoleIsExternalInvEngine -c src/ILP/demo.cpp -o $@
